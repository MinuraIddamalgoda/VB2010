#Region "   About Auhor"
'
'   UserControl Name    :   MBGlassStyleButton
'   Created             :   8 Dec 2011
'   Purpose             :   Extends style capabilities of a Button Control
'   Vision              :   1.0.1096.2286
...
#Region "   MBGlassStyleButton UserControl Code"
''' <summary>
''' MBGlassButton Class © 2011 By Manoj Kishor Bhoir
''' </summary>
''' <remarks>Version 1.0.1096.2286</remarks>
<ToolboxItem(True), ToolboxBitmap(GetType(MBGlassButton), "MBGlassStyleButton.MBGlassButton.bmp"), ToolboxItemFilter("System.Windows.Forms"), Description("Display the Bar that indicates the Progress of Operation.")> _
<DefaultEvent("Click"), DefaultProperty("Text")> _
Public Class MBGlassButton
...
#Region "   Image Settings Properties"
    ...
    ''' </summary>
    <Category("MBGlassButton Appearance"), _
    Description("Split location for MBGlassButton"), _
...
#Region "   Button Settings Properties"
    ...
    ''' </summary>
    <Category("MBGlassButton Settings"), _
    Description("Display Glass Style Base for MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Settings"), _
    Description("Radius of MBGlassButton Corners"), _
    ...
    <Category("MBGlassButton Position"), _
    Description("Set the Group Position for MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Arrow"), _
    Description("Display Arrow on MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Split Settings"), _
    Description("Split MBGlassButton into Two Parts"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Split Settings"), _
    Description("Set Split Distance for MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Appearance"), _
    Description("Keep MBGlassButton Pressed if Clicked"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Appearance"), _
    Description("Keep MBGlassButton Selected if Focused"), _
    DefaultValue(False), Browsable(True)> _
...
#Region "   Menu Position"
    ...
    ''' </summary>
    <Category("MBGlassButton Menu"), _
    Description("Set MenuList Position for MBGlassButton"), _
...
#Region "   Colors"
    ...
    ''' </summary>
    <Category("MBGlassButton Color"), _
    Description("Set Base Color of MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Color"), _
    Description("Set Mouse On Color of MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Color"), _
    Description("Set Mouse Press Color of MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Color"), _
    Description("Set Base Stroke Color of MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Color"), _
    Description("Set On Stroke Color of MBGlassButton"), _
    ...
    ''' </summary>
    <Category("MBGlassButton Color"), _
    Description("Set Press Stroke Color of MBGlassButton"), _
...
#Region "   MBGlassButton Methods"
    ...
    ''' </summary>
    Private Sub MBGlassButton_ContextMenuStripChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ContextMenuStripChanged
...
#Region "   Fading Properties"
    ...
    ''' </summary>
    <Category("MBGlassButton Appearance"), _
    Description("Set Fading Speed of MBGlassButton"), _
        ...
        Else
            ...
            If (_keeppressed) Then
                ...
                For Each _control As Control In Me.Parent.Controls
                    If _control.Name <> Me.Name And TypeOf (_control) Is MBGlassButton = True Then
                        CType(_control, MBGlassButton)._ispressed = False
                        CType(_control, MBGlassButton).UpdateMouseLeave()
                    End If
                Next
            End If
        End If
